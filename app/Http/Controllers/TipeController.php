...
class TipeController extends Controller
{
    ...
    public function store(Request $request, Tipe $tipe)
    {
        ...
        if ($tipe->create($data)) {
            return redirect('apoteker/tipe')->with('success', 'Data Tipe Obat Baru Berhasil Ditambah');
        }
    ...
    public function update(Request $request, Tipe $tipe)
    {
        ...
        if ($id_tipe !== null){
            ...
            if($dataUpdate) {
                return redirect('apoteker/tipe')->with('success', 'Data Tipe Obat Berhasil Diupdate');
            }
        }
