...
<div id="page-content-wrapper">
    <header>
        ...
        <nav class="navbar">
            <ul class="nav-list">
                <li class="nav-item">
                    <a class="btn btn-outline-danger" style="color:white;" href="{{ url('/auth/logout') }}">Logout</a>
                </li>
            </ul>
        </nav>
    </header>
